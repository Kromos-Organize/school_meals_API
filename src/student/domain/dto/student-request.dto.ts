...
export class StudentToSchoolQueryDto {
...
export class StudentRequestDto {
  ...
  @ApiProperty({
    example: false,
    description: "Параметр отвечающий многодетная семья или нет",
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiProperty({
    example: false,
    description: "Питается за счёт бюджета(true) или родителей(false)",
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiProperty({
    example: '{ m_phone: "375297485875", f_phone: "375297485875" }',
    description: "Телефоны родителей",
  })
  @ValidateNested()
...
export class UpdateStudentDto {
  ...
  @ApiProperty({ example: "Игоревич", description: "Отчество ученика" })
  @Length(0, 20, { message: "Имя должно быть от 0 до 20 символов." })
  @IsOptional()
  readonly lname?: string;
